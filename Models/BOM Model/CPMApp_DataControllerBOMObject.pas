...
type
  // ********* T Tablo adý anlamýnda I ise Index anlamýnda ****************
  ...
  TAppBOMChildIsMerkezKart = class; // (Ýþ Merkez Kartý) (T:URTISM) (I:ISMERKEZKOD)
  TAppBOMChildKaynakKart = class; // (Kaynak kartý) (T:URTKYN) (I:KAYNAKKOD)
  TAppBOMChildIsMerkezKaynakKart = class; // (Ýþ Merkezlerindeki Kaynaklar) (T:URTISK) (I:ISMERKEZKOD;KULLANIMSIRANO)
  TAppBOMChildMamulBaslik = class; // (Mamül Baþlýk) (T:MAMBAS) (I:MAMULKOD;VERSIYONNO;SURUMNO)
  TAppBOMChildMamulKart = class; // (Mamül Kartý) (T:MAMKRT) (I:MAMULKOD;VERSIYONNO;SIRANO;ID)
  TAppBOMChildOzelMamulKart = class; // (Özel Mamül Kartý) (T:STHOMK) (I:SIRANO)
  TAppBOMChildMamulRotaKart = class; // (Mamül Rotalarý) (T:MAMROT) (I:OPERASYONNO)
  TAppBOMChildMamulRotaKaynakKart = class; // (Mamül Özel Kaynak) (T:MAMKYN) (I: KULLANIMSIRANO)
  TAppBOMChildTakvimVardiyaKart = class; // (Takvim Vardiyalarý) (T:URTTKV) (I: TAKVIMKOD)
  TAppBOMChildKaynakIslemTanim = class; // (Kaynak Ýþlem Tanýmlarý) (T:URTKIT) (I:ISLEMNO)
  TAppBOMChildKaynakMamulDegisim = class; // (Mamüllerin Deðiþim Kartý) (T:URTKMD) (I:KURULUMMAMULKOD;SOKUMMAMULKOD)
  TAppBOMChildKaynakMamulKurulum = class; // (Mamüllerin Kurulum Kartý) (T:URTKMK) (I:KAYNAKKOD;MAMULKOD)
  ...
  // Ýþ Merkezlerinde bulunan Kaynaklar
  ...
  public
    ...
    procedure OpenReverse(AHammaddeKod, AHammaddeVersiyonNo: String); // Kullaným Aðacý
    procedure Close;
  published
  ...
  // Mamüle özel rota kaynak larý tanýmlý ise bu tabloya bakýlýyor.
  ...
  // Mamüllerin Kaynaklardaki deðiþim sürelerinin tutulduðu kart
...
begin
  ...
  begin
    ...
    begin
      Clear;
      // Net Ýhtiyaç Hesaplama Alanlarý
      Add('DONEMTIP');
      Add('DONEMADET');
      Add('DONEMGUNTIP');
      Add('DONEMGUNADET');
...
procedure TAppBOMChildMamulKart.CreateObjects;
  ...
  begin
    ...
    with FTableKullanimGrup.TableItems[0] do // MAMKUG --> Mamül Kullaným Grubu Tablosu
    begin
      with Fields do
      begin
        Clear;
  ...
  begin
    ...
    with FTableBaslik.TableItems[0] do // MAMBAS --> Mamül Baþlýk Tablosu
    begin
      with Fields do
      begin
        Clear;
  ...
  begin
    ...
    with FTableRevizyon.TableItems[0] do // MAMBAS --> Mamül Baþlýk Tablosu
    begin
      with Fields do
      begin
        Clear;
  ...
  begin
    ...
    FTableKart.TableItems.TableCaptions := VarArrayOf(['Mamül Kart', 'Mamül Baþlýk', 'Mamül', 'Mamül Birim', 'Hammadde', 'Hammadde Birim']);
    with FTableKart.TableItems[0] do // MAMKRT --> Mamül Kartý Tablosu
    begin
      with Fields do
      begin
        Clear;
    ...
    with FTableKart.TableItems[1] do // MAMBAS --> Mamül Baþlýðý Tablosu
    begin
      with Fields do
      begin
        Clear;
    ...
    with FTableKart.TableItems[2] do // MAMSTK --> Mamül Stok Kartý Tablosu (In Real STKKRT)
    begin
      with Fields do
      begin
        Clear;
    ...
    with FTableKart.TableItems[4] do // STKKRT --> Hammadde Stok Kartý Tablosu
    begin
      with Fields do
      begin
        Clear;
  ...
  begin
    ...
    FTableYanUrun.TableItems.TableCaptions := VarArrayOf(['Yan Ürün', 'Mamül Baþlýk', 'Mamül', 'Mamül Birim', 'Hammadde', 'Hammadde Birim']);
    ...
    with FTableYanUrun.TableItems[1] do // MAMBAS --> Mamül Baþlýðý Tablosu
    begin
      with Fields do
      begin
        Clear;
    ...
    with FTableYanUrun.TableItems[2] do // MAMSTK --> Mamül Stok Kartý Tablosu (In Real STKKRT)
    begin
      with Fields do
      begin
        Clear;
    ...
    with FTableYanUrun.TableItems[4] do // STKKRT --> Hammadde Stok Kartý Tablosu
    begin
      with Fields do
      begin
        Clear;
...
begin
  Result := 'TAKVIMKOD'; // VARDIYA INDEX DE VARDI kaldýrýldý, id ye göre almasý lazým
end;
...
begin
  ...
  with FTable.TableItems[0] do // STHOMK --> Özel Mamül Kartý Tablosu
  begin
    with Fields do
    begin
      Clear;
  ...
  with FTable.TableItems[1] do // MAMSTK --> Mamül Stok Kartý Tablosu (In Real STKKRT)
  begin
    with Fields do
    begin
      Clear;
  ...
  with FTable.TableItems[3] do // STKKRT --> Hammadde Stok Kartý Tablosu
  begin
    with Fields do
    begin
      Clear;
